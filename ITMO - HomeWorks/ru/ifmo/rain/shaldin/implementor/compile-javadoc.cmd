...
javadoc -d %user_dir%\_javadoc -link %doc_link% -private -author -version %script_dir%Implementor.java %script_dir%JarImplementor.java %modules%Impler.java %modules%JarImpler.java %modules%ImplerException.java