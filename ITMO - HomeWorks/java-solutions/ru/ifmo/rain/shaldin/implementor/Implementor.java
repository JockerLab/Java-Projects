...
/**
 * Implement {@link JarImpler} interface
 */
public class Implementor implements JarImpler {
    ...
    public void implementJar(Class<?> token, Path root) throws ImplerException {
        ...
        try {
            ...
            args.add("-cp");
            args.add(tempDir.toString() + File.pathSeparator + System.getProperty("java.class.path") + File.pathSeparator + getClassPath(token));
    ...
    public static void main(String[] args) throws ImplerException, ClassNotFoundException {
        if (args == null || args.length < 2 || args.length > 3) {
            System.err.println("Use <type_token> <dir_path>");
            return;
        }
